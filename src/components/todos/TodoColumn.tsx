...
const TodoColumn: React.FC<TodoColumnProps> = ({ category, todoList, openModal, selectedTodoId, isTouch }) => {
  ...
  return (
    <>
      <div
        className={`z-20 pb-1 mb-2 w-full bg-white border-b-2 border-gray-400 md:pt-7`}
      >
